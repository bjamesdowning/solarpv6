# Generated by Django 2.1.7 on 2019-03-27 07:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_ID', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend1.Client')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.AddField(
            model_name='service',
            name='standard_ID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend1.Test_Standard'),
        ),
        migrations.AddField(
            model_name='performance_data',
            name='model_number',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend1.Product'),
        ),
        migrations.AddField(
            model_name='performance_data',
            name='sequence_ID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend1.Test_Sequence'),
        ),
        migrations.AddField(
            model_name='certificate',
            name='location_ID',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='backend1.Location'),
        ),
        migrations.AddField(
            model_name='certificate',
            name='model_number',
